...
function render(input, out, __component, component, state) {
  ...
  out.w("<!DOCTYPE html><html lang=en><head><meta charset=UTF-8><meta http-equiv=X-UA-Compatible content=IE=edge><meta name=viewport content=\"width=device-width, initial-scale=1.0\"><link rel=stylesheet href=https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css><script src=https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js></script><link rel=stylesheet href=style.css><title>Cadastro</title></head><body style=\"background-color: #8BC6EC;\r\nbackground-image: linear-gradient(135deg, #8BC6EC 0%, #9599E2 100%)\"><nav><div style=\"background-color: black\" class=nav-wrapper><img src=img/logo_design.png alt=\"Minha Figura\" class=brand-logo><ul id=nav-mobile class=\"right hide-on-med-and-down\"><li><a href=/ > Pagina inicial </a></li><li><a href=/form>Cadastar novo aluno</a></li></ul></div></nav><div class=container style=\"margin-bottom: 20px\"><h1>Cadastro</h1><br><form action=/alunos method=post><input type=hidden name=id" +
